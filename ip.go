...
func PrintEnv(w http.ResponseWriter, r *http.Request) {
	if r.Method == "GET" {
		...
		step := fmt.Sprintf("IPv4 %v", randomdata.IpV4Address())
		InfoLogger.Printf("IPv4 %v", randomdata.IpV4Address())
		WarningLogger.Printf("IPv4 %v", randomdata.IpV4Address())
