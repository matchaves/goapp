...
func PrintEnv(w http.ResponseWriter, r *http.Request) {
	if r.Method == "GET" {
		...
		step := fmt.Sprintf("Name %v", randomdata.SillyName())
		InfoLogger.Printf("Name %v", randomdata.SillyName())
		WarningLogger.Printf("Name %v", randomdata.SillyName())
